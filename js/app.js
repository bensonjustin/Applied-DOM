(function(window) {
  ...
  btn9.addEventListener("click", event => {
    setMyLightGreen.call(btn9, event, "light-green");
  });
  ...
  const setLight11Green = setMyLightClass.bind(btn11);
  ...
  btn11.addEventListener("click", function() {
    setLight11Green(null, "light-green");
  });
  ...
  btn14.addEventListener("click", function() {
    setMyLightGreen.bind(this)("light-green");
  });
  ...
  btn15.addEventListener("click", setMyLightGreen.bind(btn15, "light-green"));
})(window);
